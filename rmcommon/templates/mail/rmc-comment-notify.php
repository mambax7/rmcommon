                            ...
                            <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                                ...
                                <tr>
                                    <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                                        ...
                                        <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 24px">
                                            <?php if ('approved' == $comment->status): ?>
                                                <?php echo sprintf(__('Click here to %s in %s', 'bxpress'), '<strong><a href="' . $uri . '#comment-' . $comment->id() . '">' . __('view the comment', 'rmcommon') . '</a></strong>',
                                                                   '<strong><a href="' . $item['url'] . '">' . $item['name'] . '</a></strong>'); ?>
                                            <?php else: ?>
                                                <?php echo sprintf(__('Click here to %s in %s', 'bxpress'), '<strong><a href="' . RMCURL . '/comments.php">' . __('view the comment', 'rmcommon') . '</a></strong>', '<strong><a href="' . $item['url'] . '">' . $item['name'] . '</a></strong>'); ?>
                                            <?php endif; ?>
                                        </p>
